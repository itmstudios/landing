...
export const Contacts = () => {
    return (
        <div className={styles.root}>
            ...
            <div className={styles.reach_us_container}>
            ...
            <div className={styles.link_container}>
                <Link
                    href="https://www.linkedin.com/company/itmstudios/"
                    className={classNames(inter.className, styles.contact_link)}
                    target="_blank"
                ...
                <Link
                    href="https://github.com/itmstudios/"
                    className={classNames(inter.className, styles.contact_link)}
                    target="_blank"
                    rel="noopener noreferrer"
                >
                ...
                <Link
                    href="https://www.youtube.com/@itm_studios"
                    className={classNames(inter.className, styles.contact_link)}
                    target="_blank"
                    rel="noopener noreferrer"
                >
